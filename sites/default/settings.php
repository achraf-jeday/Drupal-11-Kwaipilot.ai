 ...
 */
$databases["default"]["default"] = [
  "database" => "drupal11_db",
  "username" => "drupal_user",
  "password" => "drupal_password_123",
  "host" => "localhost",
  "port" => "3306",
  "driver" => "mysql",
  "prefix" => "",
 ...
 * @endcode
 */
$settings['hash_salt'] = 'iSf6moS-oMW889gwt7EOkIztfO08azlgweGemurN5JsrVJrW6AyBIAbuM0FTjQComsRdh4eA4A';
...
$settings['config_sync_directory'] = 'sites/default/files/config_tnM5y2InGmW29cpKpxm_nWhM0-YgWCWJXXH3v9X5cAmkYdKmW5onP9vyfnxMGzVPjWDH43XKgg/sync';

$config['system.performance']['css']['preprocess'] = FALSE; # Achraf !
